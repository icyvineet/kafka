...
public final class JavaDirectKafkaWordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		JavaDStream<Sensor> sensors = lines.map(new Function<String, Sensor>() {
			public Sensor call(String input) {
				return (new Sensor(input));
			}
		});
...
*/
		...
		/*sensors.foreachRDD(new Function<String, Sensor>() {
			public Sensor call(String input) {
				return (new Sensor(input));
			}
		});*/
